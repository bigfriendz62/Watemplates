    ...
    <div style={{ minHeight: "100vh", background: "#f0faf0" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 12, padding: "24px", border: "1px solid #d0ebd0", marginBottom: 24 }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, color: "#1a2f1a", marginBottom: 12 }}>How to Use WhatsApp Business Message Templates</h2>
          <div style={{ fontSize: 14, color: "#556655", lineHeight: 1.8 }}>
            <p style={{ marginBottom: 12 }}>WhatsApp business message templates help you reply to customers faster and more professionally. Instead of typing the same messages repeatedly, simply copy a template, customize the [brackets] with your specific details, and send.</p>
            <p style={{ marginBottom: 12 }}>Our templates cover the most common business situations: answering price inquiries, following up on payments, updating customers on deliveries, handling complaints, and much more.</p>
            <p><strong>Pro tip:</strong> Save your most-used templates in your WhatsApp notes or use an AI tool like Replo to generate custom replies automatically for your specific business.</p>
          </div>
        </div>
